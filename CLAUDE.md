...
## Phase 8 REDESIGN — Progress unit tracker (BUILT 2026-05-29, migration 0018 PENDING apply)
...
- Migration `0018_progress_tracker.sql` = `project_blocks.unit_count` + `block_progress_items` + `photos.progress_item_id`/`block_stage_id` + RLS + grants. **PENDING apply.**
