...
- **Phase 4 (purchase requests):** ✅ Built — now **multi-item** (header + line items) with a type-to-search material picker. 0009 applied; **migration `0014` (line items) PENDING.**
...
## Migrations
**Applied through 0013 + storage_setup on hosted Supabase (0009–0013 applied 2026-05-27). PENDING apply: `0014` (purchase_request_items + `deliveries.purchase_request_item_id`).**
